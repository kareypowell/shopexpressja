...
class RatesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Rate::create(['weight' => 12, 'rate' => 34.80, 'processing_fee' => 3.50, 'type' => 'air']);
        ...
        Rate::create(['weight' => 21, 'rate' => 57.45, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 22, 'rate' => 59.90, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 23, 'rate' => 62.35, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 24, 'rate' => 64.80, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 25, 'rate' => 67.25, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 26, 'rate' => 69.70, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 27, 'rate' => 72.15, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 28, 'rate' => 74.60, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 29, 'rate' => 77.05, 'processing_fee' => 3.50, 'type' => 'air']);
        Rate::create(['weight' => 30, 'rate' => 79.50, 'processing_fee' => 3.50, 'type' => 'air']);
