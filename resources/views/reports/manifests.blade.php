    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        @try
            ...
            @livewire('reports.report-dashboard', [
                ...
                'reportTitle' => 'Manifest Performance Report'
            ])
        @catch(\Exception $e)
            <!-- Error Fallback -->
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="mt-2 text-sm text-red-700">
                            <p>We're experiencing technical difficulties with the Manifest Performance report. Please try refreshing the page or contact support if the issue persists.</p>
                        </div>
                        <div class="mt-4">
