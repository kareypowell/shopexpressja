<div class="divide-y divide-gray-900/10">
    <div class="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
        ...
        <form class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
            ...
            <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                <button wire:click="updateProfile()" type="button" class=" rounded-md bg-wax-flower-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-wax-flower-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wax-flower-600">Update Profile</button>
            </div>
        </form>
    </div>
    ...
    <div class="grid grid-cols-1 gap-x-8 gap-y-8 py-10 md:grid-cols-3">
        ...
        <form class="bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-xl md:col-span-2">
            ...
            <div class="flex items-center justify-end gap-x-6 border-t border-gray-900/10 px-4 py-4 sm:px-8">
                <button wire:click="updatePassword()" type="button" class=" rounded-md bg-wax-flower-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-wax-flower-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-wax-flower-600">Update Password</button>
            </div>
        </form>
    </div>
