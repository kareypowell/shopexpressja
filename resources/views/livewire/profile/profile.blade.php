    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
        <div class="px-6 py-4">
            <div class="flex items-center space-x-4">
                <div class="h-12 w-12 rounded-full bg-shiraz-100 flex items-center justify-center">
                    <span class="text-lg font-semibold text-shiraz-700">
        ...
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8 px-6" aria-label="Tabs">
                <button @click="activeTab = 'profile'" 
                        :class="activeTab === 'profile' ? 'border-shiraz-500 text-shiraz-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                    Profile
                </button>
                <button @click="activeTab = 'security'" 
                        :class="activeTab === 'security' ? 'border-shiraz-500 text-shiraz-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                    Security
                </button>
                <button @click="activeTab = 'notifications'" 
                        :class="activeTab === 'notifications' ? 'border-shiraz-500 text-shiraz-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'"
                        class="whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors">
                    Notifications
                </button>
            </nav>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div>
                            ...
                            <input wire:model.lazy="firstName" id="first_name" type="text" name="first_name" autocomplete="given-name" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('firstName') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('firstName')
                        ...
                        <div>
                            ...
                            <input wire:model.lazy="lastName" type="text" name="last_name" id="last_name" autocomplete="family-name" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('lastName') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('lastName')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input wire:model.lazy="email" id="email" name="email" type="email" autocomplete="email" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('email') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('email')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input wire:model.lazy="taxNumber" id="tax_number" type="number" name="tax_number" autocomplete="given-name" minlength="9" pattern="\d{9}" maxlength="9" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('taxNumber') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('taxNumber')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input wire:model.lazy="telephoneNumber" type="text" name="telephone_number" id="telephone_number" autocomplete="tel" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('telephoneNumber') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input wire:model.lazy="streetAddress" type="text" name="street_address" id="street_address" autocomplete="street-address" 
                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('streetAddress') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                                @error('streetAddress')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input wire:model.lazy="cityTown" type="text" name="city_town" id="city_town" autocomplete="address-level2" 
                                       class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('cityTown') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                                @error('cityTown')
                                <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <select wire:model.lazy="parish" id="parish" required 
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('parish') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <select wire:model.lazy="pickupLocation" id="pickup_location" required 
                                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('pickupLocation') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input wire:model.lazy="currentPassword" id="current_password" name="current_password" type="password" autocomplete="current-password" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('currentPassword') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input wire:model.lazy="newPassword" id="new_password" name="new_password" type="password" autocomplete="new-password" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('newPassword') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            @error('newPassword')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input wire:model.lazy="confirmPassword" id="confirm_password" name="confirm_password" type="password" autocomplete="new-password" 
                                   class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-shiraz-500 focus:ring-shiraz-500 @error('confirmPassword') border-red-300 focus:border-red-500 focus:ring-red-500 @enderror">
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="email_packages" name="email_notifications" type="checkbox" checked 
                                           class="focus:ring-shiraz-500 h-4 w-4 text-shiraz-600 border-gray-300 rounded">
                                </div>
