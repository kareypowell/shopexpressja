                            ...
                            @if($customers->count() > 0)
                                ...
                                @foreach($customers as $customer)
                                    <div 
                                        ...
                                        class="cursor-pointer select-none relative py-2 pl-3 pr-9 hover:bg-shiraz-50 hover:text-shiraz-900 {{ $filterCustomer == $customer->id ? 'bg-shiraz-50 text-shiraz-900' : 'text-gray-900' }}"
                                    >
                                        <div class="flex items-center">
