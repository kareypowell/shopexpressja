                        ...
                        <div class="ml-3 flex-1">
                            ...
                            <div class="mt-2 flex items-center space-x-3">
                                @if($emailRetryCount < 3)
                                    <button wire:click="retryWelcomeEmail({{ $user->id ?? 0 }})" 
    ...
    <form wire:submit.prevent="create">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <!-- Role Selection -->
                        <div>
                            <label for="selectedRole" class="block text-sm font-medium text-gray-700">
                                User Role <span class="text-red-500">*</span>
                            </label>
                            <div class="mt-1">
                                <select wire:model="selectedRole" 
                                        id="selectedRole" 
                                        class="shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md @error('selectedRole') border-red-300 @enderror">
                            ...
                            <p class="mt-2 text-sm text-gray-500">
                                Select the appropriate role for this user. Customer role includes full profile creation.
                            </p>
                        </div>
            ...
            @if($showCustomerFields)
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Customer Profile Information</h3>
            ...
            @else
                <!-- Placeholder for non-customer roles -->
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">{{ ucfirst($selectedRole) }} Account</h3>
                            <p class="mt-1 text-sm text-gray-500">
                                {{ ucfirst($selectedRole) }} accounts require only basic information. Additional profile details are not needed.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <!-- Customer Address Information (only for customers) -->
        @if($showCustomerFields)
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            User will receive account details and login instructions
                        </p>
                        ...
                        @if($sendWelcomeEmail)
                            <div class="mt-4 space-y-3">
                                ...
                                <p class="text-sm text-gray-500">
                                    Recommended for better performance. Email will be sent in the background.
                                </p>
                            </div>
                        @endif
                    </div>
