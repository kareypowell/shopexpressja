<div>
    ...
    @if($manifest)
        ...
        @livewire('manifests.enhanced-manifest-summary', ['manifest' => $manifest], key('summary-'.$manifest->id))
    @else
        <div class="bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex items-center">
                ...
                <span class="text-red-800 font-medium">Manifest Summary Unavailable</span>
            </div>
            <p class="text-red-700 text-sm mt-1">Unable to load manifest summary. Please refresh the page.</p>
        </div>
    @endif
    @endif
