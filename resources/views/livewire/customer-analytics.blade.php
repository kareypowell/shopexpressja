<div class="space-y-6">
    ...
    <div wire:loading.flex class="items-center justify-center p-8">
        <div class="flex items-center space-x-2">
            ...
            <span class="text-gray-600">Loading customer analytics...</span>
        </div>
    </div>
            ...
            <div class="space-y-4">
                <div class="flex items-center justify-between p-3 bg-green-50 rounded-lg">
                    ...
                    <div class="text-right">
                        <div class="font-bold text-green-800">{{ number_format($customerStatusDistribution['summary']['active']) }}</div>
                ...
                <div class="flex items-center justify-between p-3 bg-yellow-50 rounded-lg">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium text-yellow-800">Inactive</span>
                    </div>
                    <div class="text-right">
                        <div class="font-bold text-yellow-800">{{ number_format($customerStatusDistribution['summary']['inactive']) }}</div>
                ...
                <div class="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                    <div class="flex items-center space-x-3">
                        ...
                        <span class="font-medium text-red-800">Suspended</span>
                    </div>
                    <div class="text-right">
                        <div class="font-bold text-red-800">{{ number_format($customerStatusDistribution['summary']['suspended']) }}</div>
    ...
    <div wire:loading.remove class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <h4 class="text-md font-medium text-gray-700 mb-3">Top Parishes</h4>
                <div class="relative h-64">
            ...
            {{-- Country Summary --}}
            <div>
                <h4 class="text-md font-medium text-gray-700 mb-3">Country Distribution</h4>
                <div class="space-y-2 max-h-64 overflow-y-auto">
                    @foreach($geographicDistribution['country_summary'] as $country)
                        <div class="flex items-center justify-between p-2 bg-gray-50 rounded">
                            <span class="text-sm font-medium text-gray-700">{{ $country['country'] ?: 'Not specified' }}</span>
                            <span class="text-sm text-gray-600">{{ number_format($country['count']) }}</span>
                        </div>
                    @endforeach
                </div>
            </div>
    ...
    <div wire:loading.remove class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <div class="bg-blue-50 rounded-lg p-4">
                ...
                <div class="text-sm text-blue-600">Active Customers</div>
            </div>
            <div class="bg-green-50 rounded-lg p-4">
                <div class="text-xl font-bold text-green-600">{{ $customerActivityLevels['summary']['average_packages_per_customer'] }}</div>
                <div class="text-sm text-green-600">Avg Packages/Customer</div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div>
                <h4 class="text-md font-medium text-gray-700 mb-3">Customer Activity Distribution</h4>
                <div class="relative h-64">
            ...
            <div>
                <h4 class="text-md font-medium text-gray-700 mb-3">Revenue by Activity Level</h4>
                <div class="relative h-64">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Revenue by Activity Chart
    const revenueActivityCtx = document.getElementById('revenueByActivityChart').getContext('2d');
